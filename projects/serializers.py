...
class ProjectListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ("id", "name", "slug", "code", "short_description", "status", "property_type", "property_type_name", "area", "area_name", "min_apartment_size", "max_apartment_size", "min_price", "max_price", "currency", "expected_handover_date", "featured_image", "is_featured")
