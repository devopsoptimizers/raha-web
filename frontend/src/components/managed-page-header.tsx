...
export async function ManagedPageHeader({contentKey,className,defaultTitle,defaultBody="",defaultLabel="",gradient="linear-gradient(rgba(0,28,52,.52),rgba(0,28,52,.8))",bodyTag="p"}:{contentKey:string;className:string;defaultTitle:string;defaultBody?:string;defaultLabel?:string;gradient?:string;bodyTag?:"p"|"span"}){
